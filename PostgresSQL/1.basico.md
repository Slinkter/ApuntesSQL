...
# SQL Básico con PostgreSQL: Fundamentos y Consultas Simples

Esta sección cubre los comandos más fundamentales de SQL usando la base de datos **Northwind en PostgreSQL**. Todos los ejemplos son ejecutables contra `db_northwind.sql`.
...
4.  **Obtener el nombre de contacto y teléfono de los clientes:**
